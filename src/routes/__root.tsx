...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "FestaCash" },
      { name: "description", content: "Carteira digital para festas e eventos." },
      ...
      { property: "og:title", content: "FestaCash" },
      { property: "og:description", content: "Carteira digital para festas e eventos." },
